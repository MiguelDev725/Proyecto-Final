...
const Cart = ({ cart, setCart }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-gray-900 text-center">Carrito de Compras</h1>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button
                    ...
                    className="mt-4 inline-block bg-red-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-red-600 transition"
                  >
                    Eliminar
                  </button>
                </div>
